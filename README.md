...
### 📚 AI Research Log (Jupyter Book)
- **研究ノート**: AI学習の軌跡をMarkdownで記録
- **論文読解レポート**: 最新AI論文の要約と分析
- **Jupyter Book統合**: 静的HTMLとしてビルドし、Webサイトで公開
- **自動ビルド**: `build-blog.bat` で簡単にHTMLを生成
